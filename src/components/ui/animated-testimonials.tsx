    ...
    <div className={cn("max-w-sm md:max-w-4xl mx-auto px-4 md:px-8 lg:px-12 py-20", className)}>
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            <h3 className="text-2xl font-bold text-premium-charcoal">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-premium-gray">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-lg text-premium-gray mt-8">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-primary text-white flex items-center justify-center group/button"
            >
